...
// 8.3.1: Surface response decoding warnings for malformed output items.
// 8.3.0: Add SQL tool loop quickstart helper.
...
// 2.2.0: Add agent resources, agent run/test APIs, run steps, and per-step run summaries.
...
// 7.4.0: Add agent messaging endpoints and types.
